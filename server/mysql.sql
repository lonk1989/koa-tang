...
CREATE TABLE `user` (
  ...
  `create_time` timestamp DEFAULT '2017-01-01 00:00:00' COMMENT '注册时间',
  `login_ip` char(15) NOT NULL DEFAULT '' COMMENT '登录IP',
  `update_time` timestamp NOT NULL DEFAULT '2017-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '最后登录时间',
...
CREATE TABLE `article` (
  ...
  `create_time` timestamp NULL DEFAULT '2017-01-01 00:00:00' COMMENT '发表时间',
  `update_time` timestamp NOT NULL DEFAULT '2017-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
...
CREATE TABLE `upload` (
  ...
  `create_time` timestamp NULL DEFAULT '2017-01-01 00:00:00' COMMENT '上传时间',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`) USING BTREE
